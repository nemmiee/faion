...
//                 $link .= "<a href=\"/faion/index.php/products?category=" . $this->category . "&page=$i\"><button class=\"page-number active\">" . $i . "</button></a>";
//             } else {
//                 $link .= "<a href=\"/faion/index.php/products?category=" . $this->category . "&page=$i\"><button class=\"page-number\">" . $i . "</button></a>";
//             }
//         }
//         return $link;
//     }
